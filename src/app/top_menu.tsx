    ...
    <header className="sticky top-0 left-0 w-full h-20 bg-gray-900 text-white z-50 shadow">
      <nav className="max-w-screen-xl mx-auto flex items-center justify-between h-full px-4 ">
        ...
        <div className="flex space-x-4">
          <a href="/schedule" className="px-4 py-2 bg-blue-600 rounded-full hover:bg-blue-700 cursor-pointer transition-transform duration-100 ease-in-out hover:scale-95">
            Programmation
          </a>
          <button
            type="button"
